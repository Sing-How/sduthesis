...
\newcommand{\prefacesize}{\fontsize{58pt}{58pt}\selectfont}
...
%%%%%%%%%%%%% Contents %%%%%%%%%%%%%%%%%
\renewcommand{\contentsname}{目\qquad\qquad 录}
...
\titleformat{\chapter}{\centering\sanhao\hei}{\sanhao\hei\chaptername}{2em}{}
...
%%%%%%%%%%%% References %%%%%%%%%%%%%%%%%
\renewcommand{\bibname}{\xiaoer\hei\textbf{参考文献}}
% 重定义参考文献样式，来自thu
\makeatletter
...
\addtolength{\bibsep}{0}     % 缩小参考文献间的垂直间距
...
\pagestyle{fancy}
  \fancyhf{}
  \fancyhead[C]{\song\xiaowu \@cheading}  % 页眉显示天津大学 20XX 届本科生毕业论文
...
%\cleardoublepage%
  ...
  \vspace*{-4em}
  \song\prefacesize{毕业论文（设计）}
  \end{center}

  \vspace*{-2em}
  \noindent\song\sanhao{\textbf{论文（设计）题目：}}

  \begin{center}
  \vspace*{3em}
  \hei\xiaoer{\textbf{\@ctitle}}
  \vspace*{16pt}
...
\chapter*{\centering\xiaoer\hei \textbf{摘\qquad \qquad 要}}
\xiaosi\song{\begin{spacing}{1.5}{\@cabstract}\end{spacing}}
\vspace{\baselineskip}

\hangafter=1\hangindent=52.3pt\noindent
{\hei\xiaosi\textbf{关键词：}} \xiaosi\song{\@ckeywords}
\thispagestyle{empty}
...
\chapter*{\centering\xiaoer{\textbf{ABSTRACT}}}
%\vspace{\baselineskip}
\xiaosi{\begin{spacing}{1.5}\@eabstract\end{spacing}}
\vspace{\baselineskip}

\hangafter=1\hangindent=60pt\noindent
{\xiaosi\textbf{Keywords:}} {\xiaosi\@ekeywords}
\thispagestyle{empty}
}
\makeatother
